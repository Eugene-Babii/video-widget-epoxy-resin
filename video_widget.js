const videos = [
	{
			...
			"product": {
					...
					"summary": "Finish pieces without worrying about any imperfections or bubbles showing up on the surface with the Epoxy Resin Kit from Craft Resin. You can expect the formula to cure in only 24 hours and you won't have to do any additional polishing. Once cured, the surface is water, scratch, and heat resistant. Thanks to the UV-stabilized formula you won’t see any yellowing over time - just a perfectly clear look that is designed to last.",
					"pros": [
					...
					"review": "I make dice and I have been using this resin for a while now and I have never had a problem. It pours wells and cures rock hard. The dice I made 3 years ago are still in use and have been dropped on the hard ground a lot and the dice never broke. If you are on the fence about getting this resin just get the smaller one any you will not be disappointed. But like any resin it says 24hr cure but the colder it is the longer it takes so if you use a pressure pot let it cure for 48 hours.",
					"faq": {
							"answer": "Resin is a chemical compound that often contains carbon, hydrogen, nitrogen, sulfur, and oxygen. The best resins don’t contain any extra solvents or VOCs (Volatile Organic Compounds).",
...
const createGalleryWidget = (title, text, textTitle = "", isReview = true, product) => {
	...
	productLink.setAttribute("style", "text-decoration: none;");
